...
{"application":"Editor de Rich Text",
    ...
    "common":{"editorHelp":"Pressione ALT+0 para ajuda",
...
"versionCheck":{"notificationMessage":"This CKEditor %current version is not secure. Consider <a target=\"_blank\" href=\"%link\">upgrading to the latest one</a>, %latest.",
...
"colordialog":{"clear":"Limpar",
    "highlight":"Grifar",
    "options":"Opções de Cor",
    "selected":"Cor Selecionada",
    "title":"Selecione uma Cor"},
"templates":{"button":"Modelos de layout",
...
"copyformatting":{"label":"Copiar Formatação",
    "notification":{"copied":"Formatação copiada",
...
"elementspath":{"eleLabel":"Caminho dos Elementos",
    "eleTitle":"Elemento %1"},
"exportpdf":{"documentReady":"Document is ready!",
    "error":"Error occurred.",
    "processingDocument":"Processing PDF document...",
    "toolbar":"Export to PDF"},
"filetools":{"loadError":"Um erro ocorreu durante a leitura do arquivo.",
...
"font":{"fontSize":{"label":"Tamanho",
    "voiceLabel":"Tamanho da fonte",
    "panelTitle":"Tamanho"},
"label":"Fonte",
"panelTitle":"Fonte",
"voiceLabel":"Fonte"},
"fakeobjects":{"anchor":"Âncora",
    "hiddenfield":"Campo Oculto",
    "iframe":"IFrame",
    "unknown":"Objeto desconhecido"},
"forms":{"button":{"title":"Formatar Botão",
    "text":"Texto (Valor)",
    "type":"Tipo",
    "typeBtn":"Botão",
    "typeSbm":"Enviar",
    "typeRst":"Limpar"},
"checkboxAndRadio":{"checkboxTitle":"Formatar Caixa de Seleção",
    "radioTitle":"Formatar Botão de Opção",
    "value":"Valor",
    "selected":"Selecionado",
    "required":"Obrigatório"},
"form":{"title":"Formatar Formulário",
    "menu":"Formatar Formulário",
    "action":"Ação",
    "method":"Método",
    "encoding":"Codificação"},
"hidden":{"title":"Formatar Campo Oculto",
    "name":"Nome",
    "value":"Valor"},
"select":{"title":"Formatar Caixa de Listagem",
    ...
    "btnDelete":"Remover"},
"textarea":{"title":"Formatar Área de Texto",
    "cols":"Colunas",
    "rows":"Linhas"},
"textfield":{"title":"Formatar Caixa de Texto",
    "name":"Nome",
    "value":"Valor",
...
"iframe":{"border":"Mostra borda do iframe",
...
"indent":{"indent":"Aumentar Recuo",
    "outdent":"Diminuir Recuo"},
"smiley":{"options":"Opções de Emoticons",
    "title":"Inserir Emoticon",
    "toolbar":"Emoticon"},
"language":{"button":"Configure o Idioma",
    "remove":"Remover Idioma"},
"link":{"acccessKey":"Chave de Acesso",
    "advanced":"Avançado",
    "advisoryContentType":"Tipo de Conteúdo",
    "advisoryTitle":"Título",
    "anchor":{"toolbar":"Inserir/Editar Âncora",
...
"unlink":"Remover Link",
"upload":"Enviar ao Servidor"},
"list":{"bulletedlist":"Lista sem números",
    "numberedlist":"Lista numerada"},
"liststyle":{"bulletedTitle":"Propriedades da Lista sem Numeros",
    "circle":"Círculo",
...
"pagebreak":{"alt":"Quebra de Página",
    "toolbar":"Inserir Quebra de Página"},
"pastetext":{"button":"Colar como Texto sem Formatação",
...
"pastefromword":{"confirmCleanup":"O texto que você deseja colar parece ter sido copiado do Word. Você gostaria de remover a formatação antes de colar?",
...
"specialchar":{"options":"Opções de Caractere Especial",
    "title":"Selecione um Caractere Especial",
    "toolbar":"Inserir Caractere Especial"},
"scayt":{"btn_about":"Sobre a correção ortográfica durante a digitação",
...
"undo":{"redo":"Refazer",
    "undo":"Desfazer"},
"widget":{"move":"Click e arraste para mover",
    "label":"%1 widget"},
"uploadwidget":{"abort":"Envio cancelado pelo usuário.",
