...
class TipoprocessoController extends \core\Controller
{
    ...
    {
        $tipo_processos = $this->model('Tipo_processos');
        $tipo_processos->setId(filterpost('id'));
		$tipo_processos->setDescricao(filterpost('descricao'));
		$tipo_processos->setPublicado(filterpost('publicado'));
		
        if($tipo_processos->save() === true) {
   ...
   public function editarcampo(): void
	{
		...
		$tipo_processos = $this->model('Tipo_processos');
		if ($tipo_processos->updateFields($_POST, $id)) {
	...
	*/
	public function excluir($id=''): void
	{
		...
		$tipo_processos = $this->model('Tipo_processos');
		if ($tipo_processos->delete($lines) === true) {
