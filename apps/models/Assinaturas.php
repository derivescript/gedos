 ...
 */
	...
	$handle = DB::table('solicitacao_assinatura');
	...
	*/
	...
	public function get($id=''){
		$solicitacao_assinatura = DB::table('solicitacao_assinatura')->get();
		return $solicitacao_assinatura;
	}

    public function find($id)
    {
        $solicitacao_assinatura = DB::table('solicitacao_assinatura')->where('id='.$id);
        return $solicitacao_assinatura[0];
    }

    public function updateFields($fields){
        $solicitacao_assinatura = DB::table('solicitacao_assinatura')->update($fields);
        if($solicitacao_assinatura==true)
        {
            return true;
        }else{
            return false;
